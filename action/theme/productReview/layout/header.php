...
<<<<<<< HEAD
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
       <a class="nav-link" class="btn btn-sm" href="myPlan.php?shop=<?php echo $_SESSION["shop_encrypt"];?>" role="button"><i
...
<<<<<<< HEAD
       ...
       <li class="nav-item">
        <a class="nav-link" class="btn btn-sm" href="help.php?shop=<?php echo $_SESSION["shop_encrypt"];?>" role="button"><i
