...
$(document).ready(function() {
  ...
  thtml+='<label for="rating">Rating</label><span class="rating">';
  thtml+='  <input id="rating5" type="radio" name="rating" value="5">';
  thtml+='  <label for="rating5">5</label>';
  thtml+='  <input id="rating4" type="radio" name="rating" value="4">';
  thtml+='  <label for="rating4">4</label>';
  thtml+='  <input id="rating3" type="radio" name="rating" value="3">';
  thtml+='  <label for="rating3">3</label>';
  thtml+='  <input id="rating2" type="radio" name="rating" value="2" checked>';
  thtml+='  <label for="rating2">2</label>';
  thtml+='  <input id="rating1" type="radio" name="rating" value="1">';
  thtml+='  <label for="rating1">1</label>';
  thtml+='</span>';
  ...
  thtml+='     <input type="file" id="file" name="file" />';
